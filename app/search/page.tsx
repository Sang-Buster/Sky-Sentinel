...
const mockSearchResults: SearchResult[] = [
  {
    ...
    confidence: 0.96,
    description:
      'Large commercial aircraft (Boeing 737) performing landing approach with clear visibility',
  ...
  const [chatMessages, setChatMessages] = useState<ChatMessage[]>([
    {
      ...
      type: 'assistant',
      content:
        "Hello! I'm your AI search assistant. I can help you find specific aircraft, drones, or events in your surveillance footage..",
                            ...
                            <div className="flex gap-4">
                              <div className="relative">
                                ...
                                <div className="absolute top-1 left-1">
                                  <Badge
                                    className={`${getDetectionColor(result.detectionType)} text-white text-xs`}
                                  >
        ...
        {chatMessages.length === 1 && (
          <div className="p-10">
            <div className="max-w-4xl mx-auto">
              <h3 className="text-sm font-medium mb-3">Try these queries:</h3>
